...
def builder():
    ...
    pat_path = '/Users/khaingwin/.pat/.digitalocean' # FIXME Parameter hard-coded to expedite testing.
...
def get_host(droplet_id, writeout_file):
    pa_token = open('/Users/khaingwin/.pat/.digitalocean').read() # FIXME redundant
